...
;
const metadata = {
    title: "InnoHR AI - Revolutionize Your HR Operations",
    description: "Transform your HR department with AI-powered recruitment, employee management, and analytics. Join thousands of companies using InnoHR AI.",
    generator: "v0.app",
    icons: {
        icon: [
            {
